...
type messageShipper struct {
	messageChannel chan *message.Msg
...
func newMessageShipper(inputChannel chan *message.Msg, subscriber *Client, givenMetricsChannel chan<- *Metric, queueName string) *messageShipper {
